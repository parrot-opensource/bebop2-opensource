/**
 * linux/arch/arm/mach-parrot7/board-fc7100-drse.c - Parrot7 Demo RSE
 *
...
static struct aai_conf_set drse_aai_conf_set[] = {
	/*
...
static struct aai_pad_t drse_aai_pads[] = {
	/* CODEC OUT CLKs */
...
static struct aai_platform_data drse_aai_pdata = {
	.pad         = drse_aai_pads,
	.aai_conf    = drse_aai_conf_set,
	.device_list = aai_dev_list,
};

static unsigned long drse_aai_pinconf[] = {
...
static unsigned long drse_aai_frame_pinconf[] = {
...
static unsigned long drse_aai_pcm_pinconf[] = {
	P7CTL_SMT_CFG(OFF)   | /* no shmitt trigger */
	P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
	P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
...
static unsigned long drse_aai_pcm_frame_pinconf[] = {
	P7CTL_SMT_CFG(ON)    | /* enable shmitt trigger */
	P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
	P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
	P7CTL_DRV_CFG(3),      /* Drive strength 3 (reg = 15) */
...
static unsigned long drse_aai_in_pinconf[] = {
	P7CTL_SMT_CFG(OFF)   | /* no shmitt trigger */
	P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
	P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
	P7CTL_DRV_CFG(3),      /* Drive strength 3 (reg = 15) */
...
static unsigned long drse_aai_in_frame_pinconf[] = {
	P7CTL_SMT_CFG(ON)    | /* enable shmitt trigger */
	P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
	P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
	P7CTL_DRV_CFG(3),      /* Drive strength 3 (reg = 15) */
...
static struct pinctrl_map drse_aai_pins[] __initdata = {
	P7_INIT_PINMAP(P7_AAI_00),
	P7_INIT_PINCFG(P7_AAI_00, drse_aai_pcm_pinconf),
	P7_INIT_PINMAP(P7_AAI_02),
	P7_INIT_PINCFG(P7_AAI_02, drse_aai_pcm_pinconf),
	P7_INIT_PINMAP(P7_AAI_03),
	P7_INIT_PINCFG(P7_AAI_03, drse_aai_pcm_frame_pinconf),
	P7_INIT_PINMAP(P7_AAI_10),
	P7_INIT_PINCFG(P7_AAI_10, drse_aai_pinconf),
	P7_INIT_PINMAP(P7_AAI_11),
	P7_INIT_PINCFG(P7_AAI_11, drse_aai_frame_pinconf),
	P7_INIT_PINMAP(P7_AAI_12),
	P7_INIT_PINCFG(P7_AAI_12, drse_aai_pinconf),
	P7_INIT_PINMAP(P7_AAI_17),
	P7_INIT_PINCFG(P7_AAI_17, drse_aai_in_frame_pinconf),
	P7_INIT_PINMAP(P7_AAI_18),
	P7_INIT_PINCFG(P7_AAI_18, drse_aai_in_pinconf),
	P7_INIT_PINMAP(P7_AAI_23),
	P7_INIT_PINCFG(P7_AAI_23, drse_aai_in_frame_pinconf),
	P7_INIT_PINMAP(P7_AAI_24),
	P7_INIT_PINCFG(P7_AAI_24, drse_aai_pinconf),
	P7_INIT_PINMAP(P7_AAI_25),
	P7_INIT_PINCFG(P7_AAI_25, drse_aai_in_pinconf),
	P7_INIT_PINMAP(P7_AAI_26),
	P7_INIT_PINCFG(P7_AAI_26, drse_aai_in_pinconf),
};
...
static struct plds_i2cs_pdata drse_i2cs_pdata = {
...
static unsigned long fc7100_drse_cam5_pinconf[] = {
...
static struct pinctrl_map drse_cam5_pins[] __initdata = {
	P7_INIT_PINMAP(P7_CAM_5_CLK),
	P7_INIT_PINCFG(P7_CAM_5_CLK, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA00),
	P7_INIT_PINCFG(P7_CAM_5_DATA00, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA01),
	P7_INIT_PINCFG(P7_CAM_5_DATA01, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA02),
	P7_INIT_PINCFG(P7_CAM_5_DATA02, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA03),
	P7_INIT_PINCFG(P7_CAM_5_DATA03, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA04),
	P7_INIT_PINCFG(P7_CAM_5_DATA04, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA05),
	P7_INIT_PINCFG(P7_CAM_5_DATA05, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA06),
	P7_INIT_PINCFG(P7_CAM_5_DATA06, fc7100_drse_cam5_pinconf),
	P7_INIT_PINMAP(P7_CAM_5_DATA07),
	P7_INIT_PINCFG(P7_CAM_5_DATA07, fc7100_drse_cam5_pinconf)
};
...
static struct avicam_dummy_info drse_cam5_dummy_driver_info = {
	.dev_id = 5,
	.format = {
...
/* mt9v117 subdev */
static int drse_mt9v117_power_on(void)
{
	gpio_set_value_cansleep(CAM5_NRST_GPIO, 1);
	return 0;
}

static int drse_mt9v117_power_off(void)
{
	gpio_set_value_cansleep(CAM5_NRST_GPIO, 0);
	return 0;
}

static int drse_mt9v117_set_power(int on)
{
	if(on == MT9V117_POWER_ON)
		return drse_mt9v117_power_on();
	else
		return drse_mt9v117_power_off();
}
...
static struct i2c_board_info drse_mt9v117_i2c_devices[] = {
	{
		I2C_BOARD_INFO("mt9v117", 0x5D),
		.platform_data = &drse_mt9v117_platform_data,
	}
};

static struct avicam_subdevs drse_mt9v117_subdevs[] = {
	{
		.board_info = &drse_mt9v117_i2c_devices[0],
...
/*tw8834 subdev */
static int drse_tw8834_power_on(void)
{
	gpio_set_value_cansleep(TW8834_NRST_GPIO, 1);
	return 0;
}

static int drse_tw8834_power_off(void)
{
...
/*tw8834 subdev */
static int drse_tw8834_power_input_enable(void)
{
	gpio_set_value_cansleep(CAM5_SWITCH_GPIO, 1);
	return 0;
}

static int drse_tw8834_power_input_disable(void)
{
	gpio_set_value_cansleep(CAM5_SWITCH_GPIO, 0);
	return 0;
}

static int drse_tw8834_set_power(int on)
{
	switch(on)	{
	case TW8834_POWER_OFF:
		return drse_tw8834_power_off();
	case TW8834_POWER_ON:
		return drse_tw8834_power_on();
	case TW8834_POWER_INPUT_DISABLE:
		return drse_tw8834_power_input_disable();
	case TW8834_POWER_INPUT_ENABLE:
		return drse_tw8834_power_input_enable();
	default:
...
static struct tw8834_platform_data drse_tw8834_platform_data = {
	.set_power = &drse_tw8834_set_power,
};

static struct i2c_board_info drse_cam5_i2c_devices[] = {
	{
		I2C_BOARD_INFO("tw8834", 0x45),
		.platform_data = &drse_tw8834_platform_data,
	}
};

static struct avicam_subdevs drse_cam5_subdevs[] = {
	{
		.board_info = &drse_cam5_i2c_devices[0],
		.i2c_adapter_id = CAM5_SUBDEVS_I2C_BUS,
		.subdevs = drse_mt9v117_subdevs,
	},
	{ NULL, 0, },
};

static struct avicam_platform_data drse_cam5_pdata = {
	...
	.bus_width	   = 8,
	.subdevs	   = drse_cam5_subdevs,
	.dummy_driver_info = &drse_cam5_dummy_driver_info,
};

static u64 drse_cam5_dma_mask = DMA_BIT_MASK(32);
static struct platform_device drse_cam5_dev = {
	.name           = "avicam",
	.id             = 5,
	.dev            = {
		.dma_mask           = &drse_cam5_dma_mask,
...
static unsigned long fc7100_drse_cam0_pinconf[] = {
       P7CTL_SMT_CFG(OFF)   | /* no shimmt trigger */
       P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
       P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
       P7CTL_DRV_CFG(3),      /* Drive strength 3(reg=15) */
};
static unsigned long fc7100_drse_cam0_clk_pinconf[] = {
...
static struct pinctrl_map drse_cam0_pins_cfg_1[] __initdata = {
	P7_INIT_PINMAP(P7_CAM_0_CLKa),
	P7_INIT_PINCFG(P7_CAM_0_CLKa, fc7100_drse_cam0_clk_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA00),
	P7_INIT_PINCFG(P7_CAM_0_DATA00, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA01),
	P7_INIT_PINCFG(P7_CAM_0_DATA01, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA02),
	P7_INIT_PINCFG(P7_CAM_0_DATA02, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA03),
	P7_INIT_PINCFG(P7_CAM_0_DATA03, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA04),
	P7_INIT_PINCFG(P7_CAM_0_DATA04, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA05),
	P7_INIT_PINCFG(P7_CAM_0_DATA05, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA06),
	P7_INIT_PINCFG(P7_CAM_0_DATA06, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA07),
	P7_INIT_PINCFG(P7_CAM_0_DATA07, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA08a),
	P7_INIT_PINCFG(P7_CAM_0_DATA08a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA09a),
	P7_INIT_PINCFG(P7_CAM_0_DATA09a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA10a),
	P7_INIT_PINCFG(P7_CAM_0_DATA10a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA11a),
	P7_INIT_PINCFG(P7_CAM_0_DATA11a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA12a),
	P7_INIT_PINCFG(P7_CAM_0_DATA12a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA13a),
	P7_INIT_PINCFG(P7_CAM_0_DATA13a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA14a),
	P7_INIT_PINCFG(P7_CAM_0_DATA14a, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA15a),
	P7_INIT_PINCFG(P7_CAM_0_DATA15a, fc7100_drse_cam0_pinconf)
};

static struct pinctrl_map drse_cam0_pins_cfg_0[] __initdata = {
	P7_INIT_PINMAP(P7_CAM_0_CLK),
	P7_INIT_PINCFG(P7_CAM_0_CLK, fc7100_drse_cam0_clk_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA00),
	P7_INIT_PINCFG(P7_CAM_0_DATA00, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA01),
	P7_INIT_PINCFG(P7_CAM_0_DATA01, fc7100_drse_cam0_pinconf),
	...
	P7_INIT_PINCFG(P7_CAM_0_DATA08, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA09),
	P7_INIT_PINCFG(P7_CAM_0_DATA09, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA10),
	P7_INIT_PINCFG(P7_CAM_0_DATA10, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA11),
	P7_INIT_PINCFG(P7_CAM_0_DATA11, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA12),
	P7_INIT_PINCFG(P7_CAM_0_DATA12, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA13),
	P7_INIT_PINCFG(P7_CAM_0_DATA13, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA14),
	P7_INIT_PINCFG(P7_CAM_0_DATA14, fc7100_drse_cam0_pinconf),
	P7_INIT_PINMAP(P7_CAM_0_DATA15),
	P7_INIT_PINCFG(P7_CAM_0_DATA15, fc7100_drse_cam0_pinconf)
};

static struct avicam_dummy_info drse_cam0_dummy_driver_info = {
	.dev_id = 0,
	.format = {
...
static struct avicam_platform_data drse_cam0_pdata = {
	...
	.bus_width	   = 16,
	.subdevs	   = NULL,
	.dummy_driver_info = &drse_cam0_dummy_driver_info,
};


static u64 drse_cam0_dma_mask = DMA_BIT_MASK(32);
static struct platform_device drse_cam0_dev = {
	.name           = "avicam",
	.id             = 0,
	.dev            = {
		.dma_mask           = &drse_cam0_dma_mask,
		.coherent_dma_mask  = DMA_BIT_MASK(32)
	}
};

void __init drse_avi_init_cameras(void)
{
	p7_init_avicam(&drse_cam5_dev,
	               &drse_cam5_pdata,
	               drse_cam5_pins,
	               ARRAY_SIZE(drse_cam5_pins));

	if (p7_chiprev() == P7_CHIPREV_R3)
		p7_init_avicam(&drse_cam0_dev,
		               &drse_cam0_pdata,
		               drse_cam0_pins_cfg_1,
		               ARRAY_SIZE(drse_cam0_pins_cfg_1));
	else
		p7_init_avicam(&drse_cam0_dev,
		               &drse_cam0_pdata,
		               drse_cam0_pins_cfg_0,
		               ARRAY_SIZE(drse_cam0_pins_cfg_0));
}
...
static unsigned long drse_lcd_pinconf[] = {
       P7CTL_SMT_CFG(OFF)   | /* no shimmt trigger */
       P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
       P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
       P7CTL_DRV_CFG(1),      /* Drive strength 1(reg=3) */
};
static unsigned long drse_lcd_clk_pinconf[] = {
       P7CTL_SMT_CFG(OFF)   | /* no shimmt trigger */
       P7CTL_PUD_CFG(HIGHZ) | /* no pull up/down unable */
       P7CTL_SLR_CFG(3)     | /* Slew rate 3 */
...
static struct pinctrl_map drse_avifb0_pins[] __initdata = {
	/* LCD1 related I/O pins */
	P7_INIT_PINMAP(P7_LCD_1_CLK),
	P7_INIT_PINCFG(P7_LCD_1_CLK, drse_lcd_clk_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA00),
	P7_INIT_PINCFG(P7_LCD_1_DATA00, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA01),
	P7_INIT_PINCFG(P7_LCD_1_DATA01, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA02),
	P7_INIT_PINCFG(P7_LCD_1_DATA02, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA03),
	P7_INIT_PINCFG(P7_LCD_1_DATA03, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA04),
	P7_INIT_PINCFG(P7_LCD_1_DATA04, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA05),
	P7_INIT_PINCFG(P7_LCD_1_DATA05, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA06),
	P7_INIT_PINCFG(P7_LCD_1_DATA06, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA07),
	P7_INIT_PINCFG(P7_LCD_1_DATA07, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA08),
	P7_INIT_PINCFG(P7_LCD_1_DATA08, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA09),
	P7_INIT_PINCFG(P7_LCD_1_DATA09, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA10),
	P7_INIT_PINCFG(P7_LCD_1_DATA10, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA11),
	P7_INIT_PINCFG(P7_LCD_1_DATA11, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA12),
	P7_INIT_PINCFG(P7_LCD_1_DATA12, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA13),
	P7_INIT_PINCFG(P7_LCD_1_DATA13, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA14),
	P7_INIT_PINCFG(P7_LCD_1_DATA14, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA15),
	P7_INIT_PINCFG(P7_LCD_1_DATA15, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA16),
	P7_INIT_PINCFG(P7_LCD_1_DATA16, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA17),
	P7_INIT_PINCFG(P7_LCD_1_DATA17, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA18),
	P7_INIT_PINCFG(P7_LCD_1_DATA18, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA19),
	P7_INIT_PINCFG(P7_LCD_1_DATA19, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA20),
	P7_INIT_PINCFG(P7_LCD_1_DATA20, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA21),
	P7_INIT_PINCFG(P7_LCD_1_DATA21, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA22),
	P7_INIT_PINCFG(P7_LCD_1_DATA22, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DATA23),
	P7_INIT_PINCFG(P7_LCD_1_DATA23, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_DEN),
	P7_INIT_PINCFG(P7_LCD_1_DEN, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_HS),
	P7_INIT_PINCFG(P7_LCD_1_HS, drse_lcd_pinconf),
	P7_INIT_PINMAP(P7_LCD_1_VS),
	P7_INIT_PINCFG(P7_LCD_1_VS, drse_lcd_pinconf),
};

/* Should we bother setting a narrower mask here? */
static u64 drse_avifb0_dma_mask = DMA_BIT_MASK(32);
static struct platform_device drse_avifb0_dev = {
	.name           = "avifb",
	.id             = 1,
	.dev            = {
		/* Todo: try to set a narrower mask */
		.dma_mask           = &drse_avifb0_dma_mask,
		.coherent_dma_mask  = DMA_BIT_MASK(32)
	}
};

static struct avi_voc_plat_data drse_avi_voc_param0 = {
	.display = "lcd.1",
};

static struct avi_voc_plat_data drse_avi_voc_param1 = {
	.display = "lcd.1",
};

static struct avifb_overlay drse_avi_lcd0_overlays[] = {
	{
		.layout		 = {
			.alpha	 = AVI_ALPHA_OSD,
			.enabled = 1,
...
static struct avifb_platform_data drse_avifb0_pdata = {
	.lcd_interface		  = {{
			.free_run = 1,
			.itu656	  = 0,
		}},
        .lcd_format_control	  = AVI_FORMAT_CONTROL_RGB888_1X24,
	.lcd_default_videomode	  = &drse_video_mode,
	.lcd_videomodes		  = p7_all_video_modes,
	.lcd_interface.ipc        = 1,
	/* default overlays */
        .overlays		  = drse_avi_lcd0_overlays,
	.overlay_nr		  = ARRAY_SIZE(drse_avi_lcd0_overlays),
	.caps                     = AVI_CAP_LCD_1 | AVI_CAP_GAM,
};

static unsigned long drse_sdhci_pins_config[] = {
	P7CTL_PUD_CFG(HIGHZ),
	P7CTL_DRV_CFG(4),
	P7CTL_SLR_CFG(2),
};

static struct pinctrl_map drse_sdhci1_pins[] __initdata = {
	P7_INIT_PINMAP(P7_SD_1_CLK),
	P7_INIT_PINCFG(P7_SD_1_CLK, drse_sdhci_pins_config),
	P7_INIT_PINMAP(P7_SD_1_CMD),
	P7_INIT_PINCFG(P7_SD_1_CMD, drse_sdhci_pins_config),
	P7_INIT_PINMAP(P7_SD_1_DAT00),
	P7_INIT_PINCFG(P7_SD_1_DAT00, drse_sdhci_pins_config),
	P7_INIT_PINMAP(P7_SD_1_DAT01),
	P7_INIT_PINCFG(P7_SD_1_DAT01, drse_sdhci_pins_config),
	P7_INIT_PINMAP(P7_SD_1_DAT02),
	P7_INIT_PINCFG(P7_SD_1_DAT02, drse_sdhci_pins_config),
	P7_INIT_PINMAP(P7_SD_1_DAT03),
	P7_INIT_PINCFG(P7_SD_1_DAT03, drse_sdhci_pins_config)
};
...
static void __init init_board(void)
{
	...
	unsigned int fb_nr = ARRAY_SIZE(drse_avi_lcd0_overlays);
	unsigned long fb_start = drse_avi_lcd0_overlays[fb_nr - 1].dma_memory.start;
	unsigned long fb_size = drse_avi_lcd0_overlays[0].dma_memory.end - fb_start + 1;
	...
	p7brd_init_sdhci(1, &fc7100_sdhci1_pdata,
			 NULL, NULL, NULL,
			 drse_sdhci1_pins, ARRAY_SIZE(drse_sdhci1_pins));
	...
	p7brd_export_gpio(144, GPIOF_OUT_INIT_HIGH, "hub");

	/* Init sound */
	p7_init_aai(drse_aai_pins, ARRAY_SIZE(drse_aai_pins), &drse_aai_pdata);
	...
	p7brd_init_i2cs(&drse_i2cs_pdata);
	...
	p7_config_pin(P7_GPIO_NR(77), P7CTL_PUD_CFG(HIGHZ));
	...
	drse_cam5_i2c_devices[0].irq = gpio_to_irq(P7_GPIO_NR(136));
	...
	p7_init_avifb(&drse_avifb0_dev, &drse_avifb0_pdata,
		      drse_avifb0_pins, ARRAY_SIZE(drse_avifb0_pins));

	p7_init_gpu_fb(fb_start, fb_size, 4);

	p7_init_avi_voc(0, &drse_avi_voc_param0);
	p7_init_avi_voc(1, &drse_avi_voc_param1);

	/*init cameras*/
	drse_avi_init_cameras();
	p7_init_avi();
...
static void __init drse_reserve_mem(void)
{
...
#define FC7100_HX270_SIZE (CONFIG_ARCH_PARROT7_FC7100_HX270_SIZE * SZ_1M)
	...
	p7_reserve_avifbmem(&drse_avifb0_dev, drse_avi_lcd0_overlays, ARRAY_SIZE(drse_avi_lcd0_overlays));

#define FC7100_VOC_SIZE (1920 * 1080 * 4 * 2)
	p7_reserve_avi_voc_mem(0, FC7100_VOC_SIZE);
	p7_reserve_avi_voc_mem(1, FC7100_VOC_SIZE);

	p7_reserve_avicammem(&drse_cam5_dev, CAM5_AVI_RAM_SIZE);
	p7_reserve_avicammem(&drse_cam0_dev, CAM0_AVI_RAM_SIZE);
...
P7_MACHINE_START(PARROT_DRSE, "DRSE")
	.reserve        = &drse_reserve_mem,
