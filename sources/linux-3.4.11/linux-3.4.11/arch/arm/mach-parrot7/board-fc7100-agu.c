/**
 * linux/arch/arm/mach-parrot7/board-agu.c - Parrot7 AGU board
 *
...
static struct avi_m2m_platform_data fc7100_agu_avi_m2m_pdata[] = {
	{ .caps = AVI_CAP_PLANAR | AVI_CAP_SCAL | AVI_CAP_CONV },
	{ .caps = 0 },
};

/** VOC connected to RAM2RAM*/
static struct avi_voc_plat_data fc7100_agu_avi_voc_m2m = {
	.display = "m2m.0",
};
...
static void __init init_board(void)
{
	...
	p7_init_avi();
	p7_init_avi_m2m(fc7100_agu_avi_m2m_pdata);
	p7_init_avi_voc(0, &fc7100_agu_avi_voc_m2m);

	/* SIM is locked */
	p7brd_export_gpio(P7_GPIO_NR(191), GPIOF_DIR_IN, "sim_locked");
}

static void __init agu_reserve_mem(void)
{
...
P7_MACHINE_START(PARROT_AGU, "AGU")
	.reserve        = &agu_reserve_mem,
