...
#define usecdiff(now, last) (((((now)->tv_sec * 1000000ULL) + (now)->tv_nsec/1000) - (((last)->tv_sec * 1000000ULL) + (last)->tv_nsec/1000)))
...
extern unsigned long long time_us(void);
extern time_t time_s(void);
