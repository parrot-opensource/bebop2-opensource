				     ...
				     unsigned long flags)
{
	...
	for_each_sg(buffer->sg_table->sgl, sg, buffer->sg_table->nents, i){
		/* some heaps (like cma) assign the sg_dma_address field.
		In this case, to not overide the value. */
...
EXPORT_SYMBOL(ion_handle_get_by_id);
