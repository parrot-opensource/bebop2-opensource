...
#endif /* LIBMTP_SUPPORT_VENDOR_CANON */
...
#endif /* LIBMTP_SUPPORT_VENDOR_OLYMPUS */
...
/**
 * ptp_android_getpartialobject64_to_handler:
 * params:	PTPParams*
 *		handle			- Object handle
 *		offset			- Offset into object
 *		maxbytes		- Maximum of bytes to read
...
#endif  /* LIBMTP_SUPPORT_VENDOR_EASTMAN_KODAK */
...
#endif  /* LIBMTP_SUPPORT_VENDOR_NIKON */
...
#endif /* LIBMTP_SUPPORT_VENDOR_SONY */
...
#endif /* LIBMTP_SUPPORT_VENDOR_KODAK */
...
#endif /* LIBMTP_SUPPORT_VENDOR_FUJI */

#ifdef LIBMTP_SUPPORT_VENDOR_PARROT

#define PARROT_SEQUOIA_DPC_DESCRIPTION(x) PTP_DPC_PARROT_SEQUOIA_##x,N_(#x)

        struct {
		uint16_t dpc;
		const char *txt;
        } ptp_device_properties_PARROT_SEQUOIA[] = {
		{PARROT_SEQUOIA_DPC_DESCRIPTION(PhotoSensorsEnableMask)},		/* 0xD201 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(PhotoSensorsKeepOn)},			/* 0xD202 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultispectralImageSize)},		/* 0xD203 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MainBitDepth)},				/* 0xD204 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultispectralBitDepth)},		/* 0xD205 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(HeatingEnable)},			/* 0xD206 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiStatus)},				/* 0xD207 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiSSID)},				/* 0xD208 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiEncryptionType)},			/* 0xD209*/
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiPassphrase)},			/* 0xD20A */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiChannel)},				/* 0xD20B */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(Localization)},				/* 0xD20C */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(WifiMode)},				/* 0xD20D */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(AntiFlickeringFrequency)},		/* 0xD210 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(DisplayOverlayMask)},			/* 0xD211 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(GPSInterval)},				/* 0xD212 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultisensorsExposureMeteringMode)},	/* 0xD213 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultisensorsExposureTime)},		/* 0xD214 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultisensorsExposureProgramMode)},	/* 0xD215 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultisensorsExposureIndex)},		/* 0xD216 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultiIrradianceGain)},			/* 0xD227 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(MultiIrradianceIntegrationTime)},	/* 0xD218 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(OverlapRate)},				/* 0xD219 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(LedsEnable)},				/* 0xD220 */
		{PARROT_SEQUOIA_DPC_DESCRIPTION(GPSEnable)},				/* 0xD221 */
		{0,NULL}
        };
	...
	if (params->deviceinfo.VendorExtensionID==PTP_VENDOR_PARROT)
		for (i=0; ptp_device_properties_PARROT_SEQUOIA[i].txt!=NULL; i++)
			if (ptp_device_properties_PARROT_SEQUOIA[i].dpc==dpc)
				return (ptp_device_properties_PARROT_SEQUOIA[i].txt);
#endif /* LIBMTP_SUPPORT_VENDOR_PARROT */
...
#endif
		{PTP_DPC_StillCaptureMode, 0, PTP_STILL_CAPTURE_MODE_NORMAL, N_("Single Shot")},	/* 5013 */
		{PTP_DPC_StillCaptureMode, 0, PTP_STILL_CAPTURE_MODE_BURST, N_("Burst")},
		{PTP_DPC_StillCaptureMode, 0, PTP_STILL_CAPTURE_MODE_TIMELAPSE, N_("Timelapse")},
#ifdef LIBMTP_SUPPORT_VENDOR_PARROT
		{PTP_DPC_StillCaptureMode, 0, PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_VIDEO, N_("Video Capture")},
		{PTP_DPC_StillCaptureMode, 0, PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_GPS_POSITION, N_("GPS position")},
		{PTP_DPC_StillCaptureMode, 0, PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_AUTOMATIC_OVERLAP, N_("Automatic Overlap")},
		{PTP_DPC_StillCaptureMode, 0, PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_CALIBRATION, N_("Calibration")},
#endif
#ifdef LIBMTP_SUPPORT_VENDOR_NIKON
...
#define PARROT_SEQUOIA_OC_DESCRIPTION(x) PTP_OC_PARROT_SEQUOIA_##x,N_(#x)
...
struct {
	...
	/* Parrot extensions */
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetSunshineValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetTemperatureValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetAngleValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetGPSValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetGyroscopeValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetAccelerometerValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetMagnetometerValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetIMUValues)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(GetStatusMask)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(EjectStorage)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(StartMagnetoCalib)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(StopMagnetoCalib)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(MagnetoCalibStatus)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(SendFirmwareUpdate)},
	{PARROT_SEQUOIA_OC_DESCRIPTION(SetGeotag)}
};
#endif /* LIBMTP_SUPPORT_VENDOR_PARROT */
...
ptp_render_opcode(PTPParams* params, uint16_t opcode, int spaceleft, char *txt)
{
	...
	if (!(opcode & 0x8000)) {
		...
		case PTP_VENDOR_PARROT:
			for (i=0;i<sizeof(ptp_opcode_parrot)/sizeof(ptp_opcode_parrot[0]);i++)
				if (opcode == ptp_opcode_parrot[i].opcode)
					return snprintf(txt, spaceleft, "%s", _(ptp_opcode_parrot[i].name));
			break;
#endif
		default:break;
		}
...
ptp_parrot_get_status_mask (PTPParams* params, uint32_t *status)
{
	...
	unsigned int size = 0;
	uint16_t ret;
	uint32_t *ptmpStatus = NULL;

	if (ptp_operation_issupported(params, PTP_OC_PARROT_SEQUOIA_GetStatusMask))
	{
		PTP_CNT_INIT(ptp);
		ptp.Code = PTP_OC_PARROT_SEQUOIA_GetStatusMask;
		ptp.Nparam = 0;
		*status = 0;
		ret = ptp_transaction(params, &ptp, PTP_DP_GETDATA, 0, (unsigned char**)&ptmpStatus, &size);
		if (ret == PTP_RC_OK && size == 4 )
			*status = *ptmpStatus;
		return ret;
	}
	else
...
ptp_parrot_set_geotag(PTPParams* params, PTPGeotag* geotag)
{
	uint16_t ret;
	PTPContainer ptp;
	unsigned char* geotagData = NULL;
	uint32_t size;

	if (!ptp_operation_issupported(params, PTP_OC_PARROT_SEQUOIA_SetGeotag))
		return PTP_RC_OperationNotSupported;

	PTP_CNT_INIT(ptp);
	ptp.Code = PTP_OC_PARROT_SEQUOIA_SetGeotag;
	ptp.Nparam = 0;

	size = ptp_pack_Parrot_Geotag(params, geotag, &geotagData);
	if (size == 0)
		return PTP_RC_GeneralError;

	ret = ptp_transaction(
		params, &ptp, PTP_DP_SENDDATA, size, &geotagData, NULL);
	free(geotagData);
