...
/* Vendor IDs
 * Reference :
 * http://www.imaging.org/site/PDFS/Standards/Final_PTP_Vendor_Extension_Registry.pdf
 */
...
#define PTP_VENDOR_SONY                 0x00000011
...
#ifdef LIBMTP_SUPPORT_VENDOR_EASTMAN_KODAK
...
#ifdef LIBMTP_SUPPORT_VENDOR_NIKON
...
#ifdef LIBMTP_SUPPORT_VENDOR_CASIO
...
#ifdef LIBMTP_SUPPORT_VENDOR_SONY
/* Sony stuff */
/* 9201:
...
#ifdef LIBMTP_SUPPORT_VENDOR_OLYMPUS
...
#ifdef LIBMTP_SUPPORT_VENDOR_PARROT
/* Parrot Sequoia device operation codes */
#define PTP_OC_PARROT_SEQUOIA_GetSunshineValues		0x9201
#define PTP_OC_PARROT_SEQUOIA_GetTemperatureValues	0x9202
#define PTP_OC_PARROT_SEQUOIA_GetAngleValues		0x9203
#define PTP_OC_PARROT_SEQUOIA_GetGPSValues		0x9204
#define PTP_OC_PARROT_SEQUOIA_GetGyroscopeValues	0x9205
#define PTP_OC_PARROT_SEQUOIA_GetAccelerometerValues	0x9206
#define PTP_OC_PARROT_SEQUOIA_GetMagnetometerValues	0x9207
#define PTP_OC_PARROT_SEQUOIA_GetIMUValues		0x9208
#define PTP_OC_PARROT_SEQUOIA_GetStatusMask		0x9209
#define PTP_OC_PARROT_SEQUOIA_EjectStorage		0x920A
#define PTP_OC_PARROT_SEQUOIA_StartMagnetoCalib		0x9210
#define PTP_OC_PARROT_SEQUOIA_StopMagnetoCalib 		0x9211
...
#ifdef LIBMTP_SUPPORT_VENDOR_CANON
...
// Still capture mode values
#define PTP_STILL_CAPTURE_MODE_NORMAL                              0x0001
#define PTP_STILL_CAPTURE_MODE_BURST                               0x0002
#define PTP_STILL_CAPTURE_MODE_TIMELAPSE                           0x0003
#ifdef LIBMTP_SUPPORT_VENDOR_PARROT
// Parrot Sequoia still capture mode values
#define PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_VIDEO                0x8001
#define PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_GPS_POSITION         0x8002
#define PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_AUTOMATIC_OVERLAP    0x8003
#define PTP_PARROT_SEQUOIA_STILL_CAPTURE_MODE_CALIBRATION          0x8004
#endif
...
/* PTP Geotag structure (sent by SetGeotag) */
...
#ifdef LIBMTP_SUPPORT_VENDOR_FUJI
/* Fuji specific */
...
#ifdef LIBMTP_SUPPORT_VENDOR_PARROT
/* Parrot Sequoia device properties codes */
#define PTP_DPC_PARROT_SEQUOIA_PhotoSensorsEnableMask		0xD201
#define PTP_DPC_PARROT_SEQUOIA_PhotoSensorsKeepOn		0xD202
#define PTP_DPC_PARROT_SEQUOIA_MultispectralImageSize		0xD203
#define PTP_DPC_PARROT_SEQUOIA_MainBitDepth			0xD204
#define PTP_DPC_PARROT_SEQUOIA_MultispectralBitDepth		0xD205
#define PTP_DPC_PARROT_SEQUOIA_HeatingEnable			0xD206
#define PTP_DPC_PARROT_SEQUOIA_WifiStatus			0xD207
#define PTP_DPC_PARROT_SEQUOIA_WifiSSID				0xD208
#define PTP_DPC_PARROT_SEQUOIA_WifiEncryptionType		0xD209
#define PTP_DPC_PARROT_SEQUOIA_WifiPassphrase			0xD20A
#define PTP_DPC_PARROT_SEQUOIA_WifiChannel			0xD20B
#define PTP_DPC_PARROT_SEQUOIA_Localization			0xD20C
#define PTP_DPC_PARROT_SEQUOIA_WifiMode				0xD20D
#define PTP_DPC_PARROT_SEQUOIA_AntiFlickeringFrequency		0xD210
#define PTP_DPC_PARROT_SEQUOIA_DisplayOverlayMask		0xD211
#define PTP_DPC_PARROT_SEQUOIA_GPSInterval			0xD212
#define PTP_DPC_PARROT_SEQUOIA_MultisensorsExposureMeteringMode	0xD213
#define PTP_DPC_PARROT_SEQUOIA_MultisensorsExposureTime		0xD214
#define PTP_DPC_PARROT_SEQUOIA_MultisensorsExposureProgramMode	0xD215
#define PTP_DPC_PARROT_SEQUOIA_MultisensorsExposureIndex	0xD216
#define PTP_DPC_PARROT_SEQUOIA_MultiIrradianceGain		0xD217
#define PTP_DPC_PARROT_SEQUOIA_MultiIrradianceIntegrationTime	0xD218
#define PTP_DPC_PARROT_SEQUOIA_OverlapRate			0xD219
/* Keep 0x21a ... 0x21f for future multisensors settings */
#define PTP_DPC_PARROT_SEQUOIA_LedsEnable			0xD220
#define PTP_DPC_PARROT_SEQUOIA_GPSEnable			0xD221
#define PTP_DPC_PARROT_SEQUOIA_SelectedStorage			0xD222
#define PTP_DPC_PARROT_SEQUOIA_MediaFolderName			0xD223
#define PTP_DPC_PARROT_SEQUOIA_XmpTag				0xD224

/* Bit-mask values for the LedsEnable property */
#define PARROT_SEQUOIA_ENABLE_LED_BODY		0x0001
#define PARROT_SEQUOIA_ENABLE_LED_IRRADIANCE	0x0002
...
uint16_t ptp_usb_event_wait_timeout(PTPParams* params, PTPContainer* event, int timeout);
...
uint16_t ptp_getpartialobject_to_handler (PTPParams* params,
				uint32_t handle, uint32_t offset,
				uint32_t maxbytes, PTPDataHandler *handler);
uint16_t ptp_android_getpartialobject64_to_handler(PTPParams* params,
 ...
 * be stored in a store that is determined by the capturing device.
 * The capturing of new data objects is an asynchronous operation.
 * This operation may be used to implement an Initiate/Terminate mechanism to
 * capture one or more objects over an initiator-controlled time period, such
 * as single long still exposure, a series of stills, audio capture, etc.
 *
 * Return values: Some PTP_RC_* code.
 **/
 ...
 * params:      PTPParams*
 *              transactionid           - TransactionID of the
 *                                        InitiateOpenCapture operation that is
 *                                        being terminated
 *
 * Used after an InitiateOpenCapture operation for situations where the capture
 * operation length is open-ended, and determined by the initiator. This
 * operation allows the termination of one capture operation that is being used
 * to capture many objects over a certain period of time. The first parameter of
 * of this operation indicates the TransactionID of the InitiateOpenCapture
 * operation that is being terminated.
 *
 * Return values: Some PTP_RC_* code.
 **/
#define ptp_terminateopencapture(params,transactionid) ptp_generic_no_data(params,PTP_OC_TerminateOpenCapture,1,transactionid)
