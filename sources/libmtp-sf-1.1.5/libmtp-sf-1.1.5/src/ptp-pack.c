...
#ifdef LIBMTP_SUPPORT_VENDOR_EASTMAN_CANON
...
static inline uint32_t
ptp_pack_Parrot_Geotag(
	PTPParams *params, PTPGeotag *geotag, unsigned char** geotagDataPtr)
{
	PTPGeotag* geotagData;

	geotagData = calloc(1, sizeof(*geotagData));
	/* The caller should free it after use! */
	if (!geotagData)
		return 0;

	htod32a((unsigned char *) &geotagData->ValidityMask,
		geotag->ValidityMask);
	htod64a((unsigned char *) &geotagData->Timestamp, geotag->Timestamp);
	htod32a((unsigned char *) &geotagData->Latitude, geotag->Latitude);
	htod32a((unsigned char *) &geotagData->Longitude, geotag->Longitude);
	htod32a((unsigned char *) &geotagData->Altitude, geotag->Altitude);
	htod32a((unsigned char *) &geotagData->NbSatellites,
		geotag->NbSatellites);
	htod32a((unsigned char *) &geotagData->AccuracyXY, geotag->AccuracyXY);
	htod32a((unsigned char *) &geotagData->AccuracyZ, geotag->AccuracyZ);
	htod32a((unsigned char *) &geotagData->NorthSpeed, geotag->NorthSpeed);
	htod32a((unsigned char *) &geotagData->EastSpeed, geotag->EastSpeed);
	htod32a((unsigned char *) &geotagData->UpSpeed, geotag->UpSpeed);
	htod32a((unsigned char *) &geotagData->Roll, geotag->Roll);
	htod32a((unsigned char *) &geotagData->Pitch, geotag->Pitch);
	htod32a((unsigned char *) &geotagData->Yaw, geotag->Yaw);

	*geotagDataPtr = (unsigned char *) geotagData;
